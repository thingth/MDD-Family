...
public class WatsonChatroom_ani extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.watsonchatroom_ani);
    ...
    private void showError(final Exception e)
    {
        runOnUiThread(new Runnable()
        {
            @Override
            public void run() {
                Toast.makeText(WatsonChatroom_ani.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent switch_msg_type = new Intent(this, WatsonChatroom.class);
